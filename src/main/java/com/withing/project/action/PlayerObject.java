...
public class PlayerObject implements PlayingEntity {
    ...
    public void win() {
        ...
        ImageIcon icon = new ImageIcon("src/main/java/com/withing/project/image/sht.jpg");
        JOptionPane.showMessageDialog(null, "先手赢","赛后提示~",JOptionPane.WARNING_MESSAGE,icon);
    }
    ...
    public void lose() {
        ...
        ImageIcon icon = new ImageIcon("src/main/java/com/withing/project/image/sht.jpg");
        JOptionPane.showMessageDialog(null, "先手输","赛后提示~",JOptionPane.WARNING_MESSAGE,icon);
    }

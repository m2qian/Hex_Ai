...
public class BeeGameAI implements PlayingEntity {
    ...
    public void win() {
        ...
        ImageIcon icon = new ImageIcon("src/main/java/com/withing/project/image/sh.jpg");
        JOptionPane.showMessageDialog(null, "后手赢","赛后提示~",JOptionPane.WARNING_MESSAGE,icon);
    }
    ...
    public void lose() {
        ...
        ImageIcon icon = new ImageIcon("src/main/java/com/withing/project/image/sh.jpg");
        JOptionPane.showMessageDialog(null, "后手输","赛后提示~",JOptionPane.WARNING_MESSAGE,icon);
    }

...
//				setBounds(坐标x，坐标y，矩形长，矩形宽)j为横向计数，i为纵向计数
        ...
        ImageIcon icon = new ImageIcon("src/main/java/com/withing/project/image/hh.png");
        JOptionPane.showMessageDialog(null, "准备比赛了呢，那就踏平一切吧~","赛前提示",JOptionPane.WARNING_MESSAGE,icon);
        String [] options = {"选择先手","选择后手","选择放弃比赛"};
        String info2 = (String)JOptionPane.showInputDialog(null,"请输入你的选项：","赛时准备",JOptionPane.QUESTION_MESSAGE,null,options,options[2]);
        String str = info2;
        Integer number;
        ...
        if(number==1){
            ...
            System.out.println("你是loser吗？？");
            exit(0);
        }
        System.out.println(str);
        //菜单***************************************
        menuBar = new JMenuBar();
        JMenu Operate = new JMenu("空虚的选择");
        JMenuItem buildTree = new JMenuItem("暂时不设置");
        ...
        //*******************************************
        frame.add(panel);
        frame.setSize(200 + 38 * SIDE + 19 * SIDE, 250 + 34 * SIDE);
